...
export const inputsCustomizations: Components<Theme> = {
  ...
  MuiToggleButton: {
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        borderRadius: '10px',
        fontWeight: 500,
        color: theme.vars!.palette.neutral['pencil-47'],
        '&:hover': {
          backgroundColor: theme.vars!.palette.action.hover,
        },
        [`&.${toggleButtonClasses.selected}`]: {
          color: theme.vars!.palette.neutral['pen-70'],
  ...
  // take stamp — checked fill is main (pen-58), the glyph is contrastText
  // (the ratio-symmetry pairing), the unselected border is the 3:1 crayon stop
    ...
    styleOverrides: {
      root: ({ ownerState, theme }) => {
        ...
        return {
          ...
          backgroundColor: vars.palette.neutral['paper-0'],
          transition: 'border-color, background-color, 120ms ease-in',
          '&:hover': {
            backgroundColor: vars.palette.neutral['highlighter-8'],
          },
  ...
  // Radio — same law, the Unify ring anatomy: unselected = 2px crayon circle on
  ...
  // COLORS live in the laws (F1: unchecked track crayon-26, checked track main,
  ...
  MuiOutlinedInput: {
    styleOverrides: {
      ...
      root: ({ theme }) => ({
        ...
        // the border law (owner C1): resting input borders are crayon-26
        border: `1px solid ${theme.vars!.palette.neutral['crayon-26']}`,
