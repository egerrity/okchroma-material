...
export function SitemarkIcon() {
  // logo marks ride the engine: brand + alt stamps for the glyph, grey for the
  // accent, ink for the wordmark (flags below keep their real-world colors)
